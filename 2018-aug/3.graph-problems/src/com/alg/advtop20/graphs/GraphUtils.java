...
public class GraphUtils {
	...
	public static int[][] completeWeightedGraph(int n) {
		int[][] in = new int[n][n];
		Random r = new Random(100);
		for(int i = 0; i < n; ++i) {
			for(int j = i+1; j < n; ++j)  {
	...
	public static int[][] completeDirectedWeightedGraph(int n) {
		int[][] in = new int[n][n];
		Random r = new Random(100);
		for(int i = 0; i < n; ++i) {
			for(int j = i+1; j < n; ++j)  {
	...
	public static int[][] randomDirectedWeightedGraph(int n) {
		int[][] in = new int[n][n];
		Random r = new Random(100);
		for(int k = 1; k <= n; ++k) {
			int ri = r.nextInt(n);
